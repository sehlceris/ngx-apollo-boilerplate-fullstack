...
export class AuthService {
  ...
  loginWithUsername(username: string, password: string): Observable<LoginWithUsername.LoginWithUsername> {
    return this.loginWithUsernameGQL
      ...
      .pipe(
        ...
        map((result: ExecutionResult) => {
          const loginWithUsername = <LoginWithUsername.LoginWithUsername> result.data.loginWithUsername;
